    ...
    \CvSubheading
      ...
      \CvItemListStart
        ...
        { {MPIC (Multi-Purpose Interior Camera)}\\\textit{part of Daimler's CIVIC "central In vehicle infotainment computer" project}}
          ...
          \item Collaborated in testing the integration between the camera driver and application over QNX. 
          \EndList}
      \CvItemListEnd
...
\section{Programming Skills}
 \CvSubHeadingListStart
   ...
   \item{
    \textbf{Technologies}{: AUTOSAR, OpenGL, GIT, Polarion, JIRA, TensorFlow}
   }  
 \CvSubHeadingListEnd
